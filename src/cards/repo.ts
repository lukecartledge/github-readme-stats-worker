import type { RepositoryData, RepoCardOptions } from './types.js'
...
/**
 * @typedef {import("../fetchers/types").RepositoryData} RepositoryData
 * @typedef {import("./types").RepoCardOptions} RepoCardOptions
 */
