 ...
 */
const statCardLocales = ({ name, apostrophe }: { name: string; apostrophe: string }): Record<string, Record<string, string>> => {
...
const repoCardLocales: Record<string, Record<string, string>> = {
  'repocard.template': {
    en: 'Template',
    ar: 'قالب',
    az: 'Şablon',
...
const langCardLocales: Record<string, Record<string, string>> = {
  'langcard.title': {
...
const wakatimeCardLocales: Record<string, Record<string, string>> = {
  'wakatimecard.title': {
    en: 'WakaTime Stats',
